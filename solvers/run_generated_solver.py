...
def run_generated_qoco(solver_dir, nruns, c, b, h):
    ...
    f = create_qoco_runtest(solver_dir, nruns, c, b, h)
...
def create_qoco_runtest(solver_dir, nruns, c, b, h):
    f = open(solver_dir + "/runtest.c", "a")
    f.write("#include <stdio.h>\n")
    f.write("#include <time.h>\n")
    f.write('#include "qoco_custom.h"\n\n')

    f.write("void update_vector_data(Workspace* work) {\n")
    ...
    f.write("       update_vector_data(&work);\n")
